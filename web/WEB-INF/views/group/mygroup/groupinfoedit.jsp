...
<main>
  ...
  <section>
    <div id="subboard">
      ...
      <div id="board">
        <form method="POST" action="/movie/group/mygroup/info/groupinfoedit.do">

          <table class="tblCGroup" id="cGroup" style="width: 1000px;">
            <tr></tr>
            <tr><td>- 그룹명 -</td></tr>
            <tr>
              <td><input type="text" class="form-control" name="gname" id="gname" value="${dto.name}" readonly></td>
            </tr>
            <tr><td id="yes" hidden>사용 가능한 그룹명입니다.</td></tr>
            <tr><td id="no" hidden>이미 존재하는 그룹명입니다.</td></tr>
            <tr><td>- 그룹 설명 -</td></tr>
            <tr>
              <td><textarea name="content" class="form-control" required>${dto.info}</textarea></td>
            </tr>
            <tr><td>- 해시태그 -</td></tr>
            <tr>
            ...
            <tr><td>- 그룹 인원 -</td></tr>
            <tr>
              <td><input type="number" name="people" class="form-control" min="30" max="300" value="${dto.recruitment
}" required></td>
            </tr>
          </table>
          <div><input type="hidden" class="btn" name="seq" value="${group}" ></div>
          <div id="hidesubmit"><button type="submit" class="btn btn-primary" id="hideBtn" hidden></button></div>

        </form>
      </div>
    </div>
    <div id="createBox"><button type="button" class="btn btn-primary" id="createBtn" onclick="subBtn()">수정하기</button></div>
